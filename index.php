                  ...
                  $counter = mysqli_num_rows($result);
									...
									echo '<div class="section group">';
										while($row = mysqli_fetch_array($result))
										{
											...
											echo '<div class="color_hex_bg" data-clipboard-text="'.$row['hex_val'].'" style="background:'.$row['rgb_val'].'">'.$row['hex_val'].'</div>';
											echo '<div class="color_info">';
											echo '<div class="color_name" style="color:'.$row['hex_val'].'">'.$row['color_name'].'</div>';
